              ...
              <div class="w-full overflow-x-auto">
                ...
                <script>
                  function confirmDelete() {
                    return confirm("Are you sure you want to delete the event?");
                  }
                </script>
                <form action="event_add_form.php" method="post">
                <button
                  class="mt-20 flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 
